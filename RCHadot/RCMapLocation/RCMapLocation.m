...
+ (BOOL)isLocationCoordinate:(CLLocationCoordinate2D)coordinate1 sameAs:(CLLocationCoordinate2D)coordinate2 {
    ...
    if ([RCVerify isFloatZero:(coordinate1.latitude - coordinate2.latitude)] && [RCVerify isFloatZero:(coordinate1.longitude - coordinate2.longitude)]) {
